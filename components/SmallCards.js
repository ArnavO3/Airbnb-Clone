...
function SmallCards(props) {
  return (
    <div className="flex items-center rounded-xl border-2 border-[#bc70f7] w-50 p-4 shadow-md shadow-[#bc70f7] cursor-pointer hover:shadow-xl hover:scale-110 transition duration-700">
